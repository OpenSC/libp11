...
!IF "$(OPENSSL_VERSION)" == ""
OPENSSL_LIBNAME = libeay32
!ELSE
OPENSSL_LIBNAME = libcrypto
!ENDIF

!IF "$(OPENSSL_STATIC_DIR)" == ""
OPENSSL_LIB = $(OPENSSL_DIR)\lib\$(OPENSSL_LIBNAME).lib
!ELSE
OPENSSL_LIB = $(OPENSSL_DIR)\lib\VC\static\$(OPENSSL_LIBNAME)MT$(DEBUG_SUFFIX).lib
!ENDIF
